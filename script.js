...
function toggle_lightmode() {
  OPT.darkmode = !OPT.darkmode;
  document.getElementById("toggle_button").classList.toggle("toggle_l");
  document.getElementById("form").classList.toggle("form_l");
  document.getElementById("heading").classList.toggle("heading_l");
  document.getElementById("header").classList.toggle("header_l");
  document.getElementById("footer").classList.toggle("footer_l");

  if(OPT.darkmode){
    document.getElementById("logo_head").src = "logo_wht.png";
  } else{
    document.getElementById("logo_head").src = "logo_blk.png";
  }
}